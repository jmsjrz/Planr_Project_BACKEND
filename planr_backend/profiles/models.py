...
class Profile(models.Model):
    ...
    social_links = models.JSONField(null=True, blank=True)  # Liens vers les comptes sociaux (LinkedIn, Twitter, etc.)
    ...
    def check_profile_completion(self):
        required_fields = [self.first_name, self.last_name, self.birth_date, self.account_type]
